    ...
    <div className="space-y-3">
      {ads.map((ad) => (
        ...
        >
          ...
          {ad.content && (
            <p className="text-xs text-white/80 leading-relaxed">{ad.content}</p>
          )}
          {ad.link_url && ad.link_text && (
            <a
              ...
              className="inline-block mt-2 text-xs font-semibold text-white hover:text-white/80 transition-colors"
            >
              {ad.link_text} →
            </a>
          )}
